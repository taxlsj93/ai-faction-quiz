# AI 진영 미디어 — 개발 지시서 v3.0

> **사업 피벗 확정 (2026-05-05)**: Phoney War 헥사곤 게임 → AI 진영 퀴즈 미디어로 전환.
...
성격·직업 퀴즈로 AI 진영(Claude/GPT/Gemini/Grok)을 배정해 소속감을 만들고,
래퍼툴 어필리에이트 + 광고 + 뉴스레터 스폰서로 수익화하는 AI 진영 미디어.
...
- Creative Bloq/Bloomberg — 에디토리얼 퀴즈, 진영 소속감 없음
- JustPickAI — 기능성 추천, 재미 없음
- **공백**: 진영 소속감 + 바이럴 구조 + 래퍼툴 어필리에이트 = 아무도 없음
...
| 파일 | 상태 | 설명 |
|------|------|------|
| `ai-faction-quiz.html` | **메인 제품 (완성)** | 6문항 AI 진영 퀴즈, 실제 통계 기반 |
...
| 진영 | 2차 CTA | 수익 구조 |
|------|---------|---------|
| Claude | jasper.ai | 25~30% 리커링 |
| GPT | jasper.ai | 25~30% 리커링 |
| Gemini | writesonic.com | 30% 리커링 |
| Grok | perplexity.ai | 확인 필요 |
...
- 도메인: ai-faction.quiz 또는 aifaction.kr 검토
...
기존 헥사곤 영토전 게임. Phase 3에서 AI 진영 미디어의 커뮤니티 이벤트로 부활 예정.
기기 감지(iOS/Android) 대신 퀴즈 진영 결과를 활용하는 방향 검토.
