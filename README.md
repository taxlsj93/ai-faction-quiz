# AI 진영 퀴즈 (AI Faction Quiz)

성격·직업 기반 6문항 퀴즈로 사용자의 **AI 진영(Claude / GPT / Gemini / Grok)** 을 배정해주는 미디어형 웹 제품입니다.
진영 소속감 + 실제 통계 기반 결과 화면 + 래퍼툴 어필리에이트 수익 구조를 결합했습니다.
